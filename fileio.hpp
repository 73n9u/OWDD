...
void appendCharArrayToFile(const char *filename, const char *data,
                           streamsize size) {
...
// void writeToFile(const string& directoryPath, const string& filename,
// istream& dataStream, const size_t inputSize) {
