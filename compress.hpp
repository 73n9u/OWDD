...
void compressGZIP(const char* input, size_t inputSize, const string& outputFileName) {
    ofstream outputFile( "/home/t3nbu/testresults/4096/object/GZIP/" + outputFileName, ios::binary);
...
void compressBZIP2(const char* input, size_t inputSize, const char* outputFileName) {
    int result;  
...
void compressLZMA(const char* input, size_t inputSize, const string& outputFileName) {
    lzma_stream stream = LZMA_STREAM_INIT; 

    ofstream outputFile("/home/t3nbu/testresults/4096/object/LZMA/" + outputFileName, ios::binary);
